...
INSERT INTO notificacion (usuario_id, id_tarea, contenido, fecha, leido) VALUES
(1, 101, 'Se te ha asignado la tarea "Diseño de interfaz".', NOW(), 0),
(1, 102, 'La tarea "Diseño de interfaz" ha sido actualizada.', NOW(), 0),
(2, 103, 'Nueva tarea disponible: "Pruebas funcionales".', NOW(), 0),
(1, NULL, 'Te han agregado al proyecto "SIGEPRO".', NOW(), 1),
(3, 104, 'La tarea "Documentación técnica" fue marcada como completada.', NOW(), 0),
(1, NULL, 'Tienes nuevas tareas asignadas esta semana.', NOW(), 0),
(2, NULL, 'Recordatorio: Reunión de equipo a las 10am.', NOW(), 1);
